      ...
      <div className="flex items-center">
        ...
        <div className="flex">
          {users.map(({ connectionId, info }) => {
            return <Avatar src={info.avatar} key={connectionId} name={info.name} />;
          })}
        </div>
      </div>
...
export const Avatar = ({ src, name }: AvatarProps) => {
  return (
    <div
      ...
      className="group -ml-2 flex shrink-0 place-content-center relative border-4 border-white rounded-full bg-gray-200"
    >
